...
public class FlightService {
    ...
    public Flight updateFlight(int flight_id, Flight flight){
        Flight oldFlight = flightDAO.getFlightById(flight_id);
        if(oldFlight == null){
            return null;
        }
        oldFlight.setDeparture_city(flight.getDeparture_city());
        oldFlight.setArrival_city(flight.getArrival_city());
        flightDAO.updateFlight(oldFlight.getFlight_id(), oldFlight);
        return oldFlight;
    }
    ...
    public List<Flight> getAllFlightsFromCityToCity(String departure_city, String arrival_city) {
        List<Flight> allflightFromCityToCity = flightDAO.getAllFlightsFromCityToCity(departure_city, arrival_city);
        return allflightFromCityToCity;
    }
}
